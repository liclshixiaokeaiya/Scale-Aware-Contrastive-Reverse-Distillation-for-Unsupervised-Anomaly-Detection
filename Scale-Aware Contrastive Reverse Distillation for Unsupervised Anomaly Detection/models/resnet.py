...
class AdaptiveBatchNorm2d(nn.Module):
    def __init__(self, pretrained_bn, myalpha=0.05):
        ...
        self.pretrained_bn = pretrained_bn  # 预训练的BatchNorm层
        self.alpha = myalpha  # 新数据的权重系数
...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        feature_a = self.layer1(x)    #16, 1024, 16, 16
        feature_b = self.layer2(feature_a)    #16, 512, 32, 32
        feature_c = self.layer3(feature_b)    #16, 256, 64, 64
...
def _resnet(
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls[arch],
                                              progress=progress,
                                              map_location='cpu')
        # state_dict = torch.load('/home/ai1004/.cache/torch/hub/checkpoints/wide_resnet50_2-95faca4d.pth', map_location='cpu')
